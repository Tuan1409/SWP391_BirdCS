...
public class UpdateProduct extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        Product product = pdo.getProductByID(id);
        System.out.println(product.toString() + "------------UpdateProduct--------------------------");        
        if(oldimg.equals(product.getImage())){ //nếu không đổi img thì lấy oldimg
