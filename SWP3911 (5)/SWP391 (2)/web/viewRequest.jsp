...
<html lang="en">
    ...
    <body onload="time()" class="app sidebar-mini rtl">
        ...
        <%
            ...
            String[] status = {"Đang chờ xét duyệt", "Đợi khách hàng xác nhận", "Đơn đặt hàng sẽ được thực hiện", "Đã từ chối"};
                                        ...
                                        <c:forEach items="${list}" var="i">
                                            ...
                                            <tr>
                                                ...
                                                <c:if test="${i.status == 1}">
                                                    <td>
                                                        <form style="width: 35px" action="InsertRequestToProduct" method="post">
                                                            ...
                                                            <input type="hidden" name="categoryID" value="${i.category.id}">
                                                            <input type="hidden" name="categoryName" value="${i.category.name}">
                                                        ...
                                                        <button class="btn btn-primary btn-sm trash" type="button" onclick="isDelete('${i.id}', '${customerID}')" title="Xóa"
                                                                ><i class="fas fa-trash-alt">Deny</i> 
                                                        </button>
                                                        <!--                                                <button class="btn btn-primary btn-sm edit" type="button" onclick="getData('')">
