                        ...
                        <div class="tile-body">
                            <div class="row element-button">
                                <div class="col-sm-2">
                                    ...
                                    <a class="btn btn-add btn-sm" href="CreateStaff" title="Thêm"><i class="fas fa-plus"></i>
                                        Tạo mới nhân viên</a>
                                    <!--                                </div>
                                                                    <div class="col-sm-2">
                                ...
                                <table class="table table-hover table-bordered" id="sampleTable">
                                    ...
                                    <tbody>
                                        <c:forEach items="${requestScope.listuser}" var="user">
                                            <tr>
                                                <td width="10"><input type="checkbox" name="check1" value="user"></td>
                                                <td>${user.id}</td>
                                                ...
                                                <td>
                                                    <c:choose>
                                                        <c:when test="${user.isActive}">
                                                            ...
                                                            <form action="DeleteStaff" method="post" id="deleteForm">
                                                        ...
                                                        <c:otherwise>
                                                            ...
                                                            <form action="AddStafff" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <script>
                            function confirmDelete(button) {
                                ...
                                swal({
                                    title: "Cảnh báo",
                                    text: "Bạn có muốn cho nghỉ nhân viên này?",
                                    buttons: ["Hủy bỏ", "Đồng ý"],
                                }).then((willDelete) => {
                                    if (willDelete) {
                                        var form = button.closest("form");
                                        form.action = "DeleteStaff?email=" + email;
                        ...
                        <script>
                            function confirmAdd(button) {
                                ...
                                swal({
                                    ...
                                    if (willDelete) {
                                        var form = button.closest("form");
                                        form.action = "AddStafff?email=" + email;
                                        form.submit();
                                    }
