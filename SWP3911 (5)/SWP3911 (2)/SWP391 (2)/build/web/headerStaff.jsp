    ...
    <body>
        ...
        <aside class="app-sidebar">
            ...
            <ul class="app-menu">
                ...
                <li><a class="app-menu__item " href="ManageOrderController?user=<%= user.getRoleid().getName()%>"><i 
                            class='app-menu__icon bx bx-id-card'></i><span class="app-menu__label">Quản lý đơn hàng</span></a>
                </li>
                <li><a class="app-menu__item " href="ManageRequestController?user=<%= user.getRoleid().getName()%>"><i 
                            class='app-menu__icon bx bx-id-card'></i><span class="app-menu__label">Quản lý đơn đặt hàng</span></a>
                </li>
