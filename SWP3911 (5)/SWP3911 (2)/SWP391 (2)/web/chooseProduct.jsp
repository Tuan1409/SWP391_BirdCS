                                ...
                                <c:forEach items="${list}" var="i">
                                    <div class="col-lg-12 mb-4">
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-md-4"> <!-- Column for the image (adjust the column width as needed) -->
                                                        <img src="img/${i.image}" alt="Cho nay la anh" width="100px;">
                                                    </div>
                                                    <div class="col-md-8"> <!-- Column for product information (adjust the column width as needed) -->
                                                        <h4 class="card-title">${i.name}</h4>
                                                        <p class="card-text"><span class="font-weight-bold text-black">Số lượng : ${i.stock}</p>
                                                        <p class="card-text"><span class="font-weight-bold text-black">Đơn giá : </span> &nbsp; <fmt:formatNumber value="${i.price}" type="currency"/></p>
                                                        <p class="card-text"><span class="font-weight-bold text-black">Kích Thước :</span> &nbsp;  ${i.size}</p>
