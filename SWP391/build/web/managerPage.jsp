    ...
    <body>
        ...
        <aside class="app-sidebar">
            <div class="app-sidebar__user">
                <img style=" border-radius: 50%; " class="app-sidebar__user-avatar rounded" src="img/${sessionScope.USER.image}" width="100px"  alt="User Image">
                <div>
            ...
            <ul class="app-menu">
                ...
                <li><a class="app-menu__item " href="ManagerStaffController"><i 
