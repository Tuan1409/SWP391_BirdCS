...
public class ProductDTO {
    ...
    public ProductDTO(int productID, String name, String code, int material, String size, int price, float discount, CategoryDTO category, int stock, int isAvailable, int quantitySold, double rate_sum, double rate_count, String image) {
