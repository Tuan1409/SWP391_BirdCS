...
//                        "from Promotion v left join Account a on v.AccountID = a.id";
            ...
            while (rs.next()) {
                ...
                Promotion promotion = new Promotion(promotionID, promotionName, dateStart, dateEnd, promotionStatus, value, acc);
     ...
     public void addPromotion(String promotionName, Date dateStart, Date dateEnd, boolean promotionStatus, int value, int accountID) {
