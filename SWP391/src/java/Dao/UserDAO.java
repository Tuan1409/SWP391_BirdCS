...
//To change body of generated methods, choose Tools | Templates.
    ...
    public void insertstaff(String firstname, String lastname, String image, String address, String birthday, String gender, String role, String email, String password) throws ClassNotFoundException {
      String sql = "INSERT INTO Account"
                + "(firstname,lastname, email, password, gender, birthday, RoleId, address,image,isActive )\n"
                + "VALUES(?, ?, ?, ?, ?, ?, ?, ?, ? ,'true')";
        Connection conn = null;
        PreparedStatement ps = null;
        ResultSet rs = null;
...
//To change body of generated methods, choose Tools | Templates.
    ...
    public void insertuser(String firstname, String lastname, String address, String birthday, String gender,  String email, String password) throws ClassNotFoundException {
       String sql = "INSERT INTO Account"
                + "(firstname,lastname, email, password, gender, birthday, RoleId, address,isActive )\n"
                + "VALUES(?, ?, ?, ?, ?, ?, '1', ?, ? ,'true')";
        Connection conn = null;
        PreparedStatement ps = null;
        ResultSet rs = null;
