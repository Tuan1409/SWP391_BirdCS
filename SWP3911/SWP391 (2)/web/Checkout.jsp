        ...
        <div class="container-fluid pt-5 pb-3">
            ...
            <div class="row px-xl-5"  >
                ...
                <form action="checkout" method="post">
                    <label>Email</label>
                    <br>
                    <input type="text" name="email" required="" value="${sessionScope.userlogin.firstname}"/>
                    <br>
                    <label>Last Name</label>
                    <br>
                    <input type="text" name="lastname" required="" value="${sessionScope.userlogin.lastname}"/>
                    <br>
                    <label>Phone</label>
                    <br>
                    <input type="text" name="phone" required="" value="${sessionScope.userlogin.phone}" />
                    <br>
                    <label>Address</label>
                    <br>
                    <input type="text" name="address" required="" value="${sessionScope.userlogin.address}"/>
                    <div>Tổng tiền : ${requestScope.totalPrice}</div>
